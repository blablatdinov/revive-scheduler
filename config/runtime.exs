...
#
#     PHX_SERVER=true bin/revive_scheduler start
#
...
if config_env() == :prod do
  ...
  config :revive_scheduler, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :revive_scheduler, ReviveScheduler.Mailer,
